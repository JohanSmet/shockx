...
void ResReadDirEntries(int filenum, ResDirHeader *pDirHead, uint32_t add_flags);
void ResProcDirEntry(ResDirEntry *pDirEntry, int filenum, long dataOffset, uint32_t add_flags);
